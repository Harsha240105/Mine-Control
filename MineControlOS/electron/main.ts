  ...
  const menuTemplate: Electron.MenuItemConstructorOptions[] = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { label: 'Connection', accelerator: 'CmdOrCtrl+4', click: () => mainWindow?.webContents.send('navigate', '/connection') },
        { label: 'Worlds', accelerator: 'CmdOrCtrl+5', click: () => mainWindow?.webContents.send('navigate', '/worlds') },
        { label: 'Backups', accelerator: 'CmdOrCtrl+6', click: () => mainWindow?.webContents.send('navigate', '/backups') },
        { type: 'separator' },
